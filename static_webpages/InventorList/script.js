function showInventor() {
    ...
    else if (inventor === "ritchie") {
        document.getElementById("inventorImage").src = data[inventor].img;
        document.getElementById("inventorImage").classList.add("square-image");
        document.getElementById("inventorImage").classList.remove("circle-image");
